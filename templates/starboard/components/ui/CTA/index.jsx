        ...
        <SectionWrapper className="overflow-hidden">
            <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
                <LayoutEffect isInviewState={{
                    ...
                    <div className="flex-none max-w-xl mt-12 space-y-3 delay-200 duration-300 ease-in md:mt-0">
                        <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                            Transform Your Videos into Engaging Blog Posts and Social Media Content!
                        </h2>
                        <p className="text-gray-600">
                            Our AI-driven platform effortlessly converts your video content into polished blog or social media text, tailored to your unique style and needs. Share your story more widely and effectively with our innovative solution.
                        </p>
                        <div className='pt-1'>
                            <NavLink href="#get-started" className="inline-block w-full font-medium text-sm text-white bg-sky-500 hover:bg-sky-600 active:bg-sky-700 shadow rounded-lg sm:w-auto">
                ...
                <LayoutEffect isInviewState={{
                    ...
                    <div className="flex-none w-full delay-200 duration-300 ease-in md:max-w-lg">
                        <Image
                            src={cta_image} // Make sure to replace this with your desired CTA image path
                            alt="CTA image showcasing video-to-text transformation"
                            className='w-full shadow-lg rounded-lg border'
                        />
                    </div>
                </LayoutEffect>
